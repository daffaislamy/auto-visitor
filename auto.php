...
";
                ...
                $opt = ['https://www.google.co.id', 'https://www.youtube.com', 'https://www.google.com', 'https://www.dfaxplot.ml', 'https://www.yahoo.com', 'https://www.yandex.ru', 'https://www.wikipedia.org'];
                echo $fgreen . "
[#] Mengirim ... 
";
                for ($i = 1;$i < $b + 1;++$i) {
...
";
                            ...
                            echo $merah . "[!] Diopsi gak ada pilihan '" . $orange . $c . $merah . "' palkon !!
